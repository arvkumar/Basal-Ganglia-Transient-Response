...
for connchanges in pdConnRestor:
	...
	argument = 'template_15thFeb_dop840_poisson_SI_V7_synwtchng4mPDTrip.py ' + ' ' + str(connchanges) + ' ' + str(pdConnRestor[connchanges]["Source"]) + ' ' + str(pdConnRestor[connchanges]["Target"] + ' ' + sys.argv[1]) + ' ' + str(0.0)
	print (argument)
