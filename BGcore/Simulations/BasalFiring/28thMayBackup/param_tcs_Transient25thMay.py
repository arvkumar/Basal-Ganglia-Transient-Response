...
import Simulations.BasalFiring.param_val_Transient25thMay as params
...
noise = {		
	...
	'D2' : {'rate' : 1950.0}, #2196.0},# 2196.0}, #changed from 1900 to make D1 and D2 basal firing rate comparable(14th feb)
	'FSN' : {'rate' : 1820.0}, #1300.0},
	'GPTA' : {'rate' : 310.5}, #3000.0},# changed from 700 to make TA bit higher @ basal (14th feb)
	'GPTI' : {'rate' : 925.0}, #900.0},
	#'STN' : {'rate' : 2340.0},
...
nparam = {
"GPI":{"a":3.0, "b":200.0, "Delta_T":1.8, "tau_w":20.0, "V_reset":-65.0, "V_th": -55.2, "tau_syn_ex":2.0, "tau_syn_in":1.7, "E_L":-55.8, "E_ex":0.0, "E_in":-80.0, "I_e":0.0, "C_m":80.0, "g_L":3.0, "t_ref":p.tref}, # retained to 1.7 from 1.55 #changed from "tau_syn_in":1.7 to bring down Gpi ((14th feb)), changed from "tau_syn_ex":6.0

"STN":{"V_reset":-70.0, "V_th": -64.0, "tau_syn_ex":.33, "tau_syn_in":6.0, "E_L":-80.2, "E_ex": -10.0, "E_in":-84.0, "I_e":1.0, "C_m":60.0, "g_L":10.0, "t_ref":p.tref},

"GPTI" : {"a":2.5, "b":70.0, "Delta_T":1.7, "tau_w":20.0, "V_reset":-60.0, "V_th": -54.7, "tau_syn_ex":0.6, "tau_syn_in":1.0, "E_L":-55.1, "E_ex":0.0, "E_in":-65.0, "I_e":12.0, "C_m":40.0, "g_L":1.0, "t_ref":p.tref},
